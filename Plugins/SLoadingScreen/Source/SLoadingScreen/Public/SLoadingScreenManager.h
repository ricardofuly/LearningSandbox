...
#include "SLoadingScreenManager.generated.h"


#define UE_API SLOADINGSCREEN_API
...
UCLASS(MinimalAPI)
class USLoadingScreenManager : public UGameInstanceSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
	...
	FORCEINLINE FOnLoadingScreenVisibilityChangedDelegate& OnLoadingScreenVisibilityChangedDelegate() { return LoadingScreenVisibilityChanged; }
	 ...
	 UE_API void UnregisterLoadingProcessor(TScriptInterface<ISLoadingProcessInterface> Interface);
...
private:
	...
	TArray<TWeakInterfacePtr<ISLoadingProcessInterface>> ExternalLoadingProcessors;
	...
	float CurrentLoadingScreenProgress = 0.0f;
};
