...
#include "SLoadingScreenSettings.generated.h"

/**
 * 
 */
UCLASS(config=Game, defaultconfig, meta=(DisplayName="Loading Screen"))
class SLOADINGSCREEN_API USLoadingScreenSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()
public:
	USLoadingScreenSettings();
