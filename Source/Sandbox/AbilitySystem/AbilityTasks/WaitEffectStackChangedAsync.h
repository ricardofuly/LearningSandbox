...
#include "WaitEffectStackChangedAsync.generated.h"
...
UCLASS()
class SANDBOX_API UWaitEffectStackChangedAsync : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	static UWaitEffectStackChangedAsync* ListenForGameplayEffectStackChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
